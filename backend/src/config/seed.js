...
async function seed() {
  ...
  try {
    ...
    const settings = [
      ...
      ['allow_candles', '1'],
      ['home_banner_quote_en', '"Those who do not remember the past are condemned to repeat it."'],
      ['home_banner_quote_ml', '"ഭൂതകാലത്തെ ഓർക്കാത്തവർ അത് ആവർത്തിക്കാൻ വിധിക്കപ്പെടുന്നു."'],
      ['home_banner_cite_en', '— George Santayana'],
      ['home_banner_cite_ml', '— ജോർജ് സന്തായന'],
      ['home_mission_title_en', 'Our Family Heritage'],
      ['home_mission_title_ml', 'നമ്മുടെ കുടുംബ പൈതൃകം'],
      ['home_mission_text_en', 'This memorial is a living archive of our family history — a place where stories are preserved, photos are cherished, and the flame of memory never fades. Explore the branches of our family tree, light a candle in loving memory, and leave your tribute for generations to come.'],
      ...
      ['home_cta_title_en', 'Preserve Your Family Story'],
      ['home_cta_title_ml', 'നിങ്ങളുടെ കുടുംബ കഥ സംരക്ഷിക്കുക'],
      ['home_cta_text_en', 'Our family legacy is built on the lives we live and the memories we share. Every name, every face, every story matters.'],
      ['home_cta_text_ml', 'നമ്മുടെ കുടുംബ പാരമ്പര്യം നാം ജീവിക്കുന്ന ജീവിതങ്ങളിലും പങ്കിടുന്ന ഓർമ്മകളിലും നിർമ്മിച്ചിരിക്കുന്നു. ഓരോ പേരും, ഓരോ മുഖവും, ഓരോ കഥയും പ്രധാനമാണ്.'],
    ];
